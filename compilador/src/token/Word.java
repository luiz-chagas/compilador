...
public class Word extends Token {
    ...
    public static final Word w_and = new Word("and", Tag.AND);
    public static final Word w_or = new Word("or", Tag.OR);

    public static final Word w_program = new Word("program", Tag.PROGRAM);
    ...
    public static final Word w_int = new Word("int", Tag.INT);
    ...
    public static final Word w_sum = new Word("+", Tag.MAIS);
    public static final Word w_sub = new Word("-", Tag.MENOS);
    public static final Word w_mult = new Word("*", Tag.VEZES);
